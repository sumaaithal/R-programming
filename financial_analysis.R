...
# Results for dollar values need to be calculated with $0.01 precision, but need to be3
...
good_months <- round(profit_after_tax[profit_after_tax > mean(profit_after_tax)])

good_months

bad_months <- round(profit_after_tax[profit_after_tax < mean(profit_after_tax)])

bad_months

max(round(profit_after_tax))

min(round(profit_after_tax))
